...
func Batch_projects_locations_operations_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateBatch_projects_locations_operations_listTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Batch_projects_locations_operations_listHandler(cfg),
	}
}
